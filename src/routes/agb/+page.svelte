...
<div class="$mx-auto $mb-4" style="max-width: 48rem;">
	...
	<p>
		...
		einen unverbindlichen Online-Katalog dar. Sie können unsere Produkte zunächst unverbindlich in
	...
	<p>
		...
		Zahlungstransaktion richtet sich nach der jeweils ausgewählten Zahlungsart (s. unter
		„Bezahlung“).
	</p>
	<p>
	...
	<p>
		Zuzüglich zu den angegebenen Produktpreisen kommen noch Versandkosten hinzu. Näheres zur Höhe
		der Versandkosten erfahren Sie bei den Angeboten.
	</p>
	<p>
