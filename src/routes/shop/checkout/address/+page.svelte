<script lang="ts">
	...
	import type { XioniApi } from '$lib/boilerplate/xioni/XioniApi.types'
	...
	function updateOrder() {
		...
		orderApi
			...
			.catch(response => {
				const { details: errors } = (response as XioniFetchErrorResponse).data

				formBodyErrors = errors.body || undefined
				formMessageError = errors.message ? head(errors.message) : undefined
