...
<svelte:head>
	<title>Widerrufsbelehrung | {title}</title>
...
<Wrapper class="$px-0">
	...
	<p>
		(2) Das Widerrufsrecht besteht nicht bei Verträgen zur Lieferung von Ton- oder Videoaufnahmen
		oder Computersoftware in einer versiegelten Packung, wenn die Versiegelung nach der Lieferung
		entfernt wurde.
	</p>
	<p>
